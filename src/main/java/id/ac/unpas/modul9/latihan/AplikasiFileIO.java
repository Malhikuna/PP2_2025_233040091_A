package id.ac.unpas.modul9.latihan;
...
public class AplikasiFileIO extends JFrame {
    ...
    public AplikasiFileIO() {
        ...
        btnAppendText.addActionListener(e -> tambahTextKeFile());
    }
    ...
    private void simpanConfigBinary()
    {
        try (DataOutputStream dos = new DataOutputStream(new FileOutputStream("config.bin"))) {
            // Kita simpan ukuran dont saat ini (Integer)
    ...
    private void tambahTextKeFile() {
        if (fileChooser.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
            ...
            try (BufferedWriter writer = new BufferedWriter(new FileWriter(file, true))) {
                ...
                JOptionPane.showMessageDialog(this, "Teks berhasil ditambahkan di akhir file!");
            } catch (IOException ex) {
